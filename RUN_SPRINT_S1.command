...
cat > tools/tag_semantics_backlog_and_seed.py <<'PY'
...
echo "Running S1 semantics audit..."
python3 tools/tag_semantics_backlog_and_seed.py

echo
echo "DONE."
echo "Outputs: _archive/sprints/S1_semantics_<timestamp>/"
echo "Ledger:  _archive/sprints/_ledger/SPRINT_LEDGER.md"
echo "Enrich:  enrichment/tag_specs_v0.1.json"
echo
